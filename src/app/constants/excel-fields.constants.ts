...
import { SYSTEM_CONFIG_KEYS } from './general.constants';

/** Mapeo de entityField → { group, fieldKey } para resolver opciones dinámicas desde SystemConfigIndexeddbRepository */
export const EXCEL_OPTIONS_CONFIG_MAP: Record<string, { group: string; fieldKey: string }> = {
...
/** Definición base de todos los campos disponibles en FeedbackEntity para el mapeo Excel */
export const EXCEL_DEFAULT_FIELDS: ExcelColumnMapping[] = [
  // Campos básicos
